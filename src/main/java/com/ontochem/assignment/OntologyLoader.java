...
public class OntologyLoader {
   ...
   */
    ...
    final boolean isModuleCdkOrAmbit = ChemLib.CHEMLIB_CDK.equals( _module ) || 
		  ...
		  while ( ( inLine = inObo.readLine() ) != null ) {
		    ...
		    if ( inLine.startsWith( "[Term]" ) ) {
		      ...
		      while ( ( inConceptLine = inObo.readLine() ) != null ) {
		        ...
		        final 
		        String tag   = inConceptLine.substring( 0, tagSepOff );
		        ...
		        if ( "id".equals( tag ) ) {
		          ...
		          parentSet.add( value );
              //System.out.println( "is_a: "+value );
		          
		        } else if ( "has_a".equals( tag ) ) {
		          childSet.add( value );
              //System.out.println( id + " has_a: "+value );
